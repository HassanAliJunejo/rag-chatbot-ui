#!/usr/bin/env python3
"""
AI Agent for the RAG Chatbot System

This script implements the core AI agent functionality for the RAG chatbot.
It handles user queries, performs semantic search in the knowledge base,
...
import sys
import os
# Add the parent directory to the path to import from the parent directory
...
def main():
    ...
    """
    print("AI Agent for Book Content")
    print("Ask questions about the book content, or type 'quit' to exit.")
    print("The agent will answer ONLY from retrieved chunks.")
    print("-" * 50)
